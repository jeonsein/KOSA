$(() => {
    ...
    $.ajax({
        url: "http://192.168.1.21:8888/backspringconfiguration/productjson",
        method: 'get',
        data: queryStr,
    ...
    $('div.product>div>ul>li>button').click(()=>{
        ...
        $.ajax({
            ...
            url: 'http://192.168.1.21:8888/backspringconfiguration/addcart',//'http://localhost:8888/back/addcart',
            method : 'get',
